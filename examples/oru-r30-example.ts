...
const pid = new PID()
  ...
  .administrativeSex("F")
  .patientAddress("456 Oak Ave", "", "Boston", "MA", "02101", "USA")
  .phoneNumberHome("555-9876");
// Build PV1 segment
const pv1 = new PV1()
  .setId("1")
  .patientClass("E")
  .assignedPatientLocation("ER", "5", "B", "Main")
  .attendingDoctor("5678", "Johnson", "Robert")
...
const obx1 = new OBX()
  ...
  .units("mg/dL", "milligrams per deciliter", "UCUM")
