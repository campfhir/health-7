/**
 * Parser for ADT^A41 messages (HL7 v2.5.1).
 *
 * @module
 */
...
/** Structured result of parsing an HL7 ADT^A41 (v2.5.1) message. */
export type ParsedADT_A41 = ParsedADT_A34;

/** Parser for HL7 ADT^A41 (v2.5.1) messages. */
...
/** Parses an HL7 ADT^A41 (v2.5.1) message string into a structured result. */
