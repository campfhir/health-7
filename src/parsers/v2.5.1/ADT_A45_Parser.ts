/**
 * Parser for ADT^A45 messages (HL7 v2.5.1).
 *
 * @module
 */
...
/** Structured result of parsing an HL7 ADT^A45 (v2.5.1) message. */
export type ParsedADT_A45 = ParsedADT_A34;

/** Parser for HL7 ADT^A45 (v2.5.1) messages. */
...
/** Parses an HL7 ADT^A45 (v2.5.1) message string into a structured result. */
