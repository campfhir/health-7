/**
 * Parser for SIU^S13 messages (HL7 v2.5.1).
 *
 * @module
 */
...
import {
  SIU_S13_Parser as SIU_S13_Parser_base,
  type ParsedSIU_S13,
...
} from "../v2.3/SIU_S13_Parser.ts";

export type { ParsedSIU_S13, ParsedSIUPatient, ParsedSIUResources, ParsedSIUService, ParsedSIUGeneralResource, ParsedSIULocationResource, ParsedSIUPersonnelResource };

/** Parser for HL7 SIU^S13 (v2.5.1) messages. */
export class SIU_S13_Parser extends SIU_S13_Parser_base {
  /** Parse msh. */
...
/** Parses an HL7 SIU^S13 (v2.5.1) message string into a structured result. */
