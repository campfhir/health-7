...
test("Parse and modify - Add OBR with ORC", () => {
  ...
  const newOrc = new ORC()
    ...
    .orderingProvider({ id: "999", familyName: "TEST", givenName: "DOCTOR" });

  const newObr = new OBR()
    .setId("4")
    .placerOrderNumber("NEW001")
    .fillerOrderNumber("LABNEW")
    .universalServiceIdentifier({ identifier: "ALT", text: "ALT", nameOfCodingSystem: "L" })
  ...
  const newObx = new OBX()
    .setId("1")
    .valueType("NM")
    .observationIdentifier({ identifier: "1742-6", text: "ALT", nameOfCodingSystem: "LN" })
    .observationSubId("1")
    .observationValue("35")
    .units({ identifier: "U/L" })
    .referenceRange("7-56")
    .abnormalFlags("N")
    .observationResultStatus("F");
