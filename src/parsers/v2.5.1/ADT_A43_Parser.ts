/**
 * Parser for ADT^A43 messages (HL7 v2.5.1).
 *
 * @module
 */
...
/** Structured result of parsing an HL7 ADT^A43 (v2.5.1) message. */
export type ParsedADT_A43 = ParsedADT_A34;

/** Parser for HL7 ADT^A43 (v2.5.1) messages. */
...
/** Parses an HL7 ADT^A43 (v2.5.1) message string into a structured result. */
