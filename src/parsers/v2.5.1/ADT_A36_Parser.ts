/**
 * Parser for ADT^A36 messages (HL7 v2.5.1).
 *
 * @module
 */
...
/** Structured result of parsing an HL7 ADT^A36 (v2.5.1) message. */
export type ParsedADT_A36 = ParsedADT_A34;

/** Parser for HL7 ADT^A36 (v2.5.1) messages. */
...
/** Parses an HL7 ADT^A36 (v2.5.1) message string into a structured result. */
