/**
 * Parser for SIU^S17 messages (HL7 v2.5.1).
 *
 * @module
 */
...
/** Parser for HL7 SIU^S17 (v2.5.1) messages. */
...
/** Parses an HL7 SIU^S17 (v2.5.1) message string into a structured result. */
