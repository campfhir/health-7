/**
 * Parser for ADT^A13 messages (HL7 v2.5.1).
 *
 * @module
 */
...
/** Structured result of parsing an HL7 ADT^A13 (v2.5.1) message. */
export type ParsedADT_A13 = ParsedADT_A01;

/** Parser for HL7 ADT^A13 (v2.5.1) messages. */
...
/** Parses an HL7 ADT^A13 (v2.5.1) message string into a structured result. */
