/**
 * Parser for SIU^S26 messages (HL7 v2.3).
 *
 * @module
 */
...
/** Structured result of parsing an HL7 SIU^S26 (v2.3) message. */
export type ParsedSIU_S26 = ParsedSIU_S12;

/** Parser for HL7 SIU^S26 (v2.3) messages. */
export class SIU_S26_Parser extends SIU_S12_Parser {}

/** Parses an HL7 SIU^S26 (v2.3) message string into a structured result. */
