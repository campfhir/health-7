/**
 * Parser for ADT^A30 messages (HL7 v2.3).
 *
 * @module
 */
...
/** Structured result of parsing an HL7 ADT^A30 (v2.3) message. */
export type ParsedADT_A30 = ParsedADT_A34;

/** Parser for HL7 ADT^A30 (v2.3) messages. */
...
/** Parses an HL7 ADT^A30 (v2.3) message string into a structured result. */
