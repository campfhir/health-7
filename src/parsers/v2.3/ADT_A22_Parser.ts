/**
 * Parser for ADT^A22 messages (HL7 v2.3).
 *
 * @module
 */
...
/** Structured result of parsing an HL7 ADT^A22 (v2.3) message. */
export type ParsedADT_A22 = ParsedADT_A01;

/** Parser for HL7 ADT^A22 (v2.3) messages. */
...
/** Parses an HL7 ADT^A22 (v2.3) message string into a structured result. */
