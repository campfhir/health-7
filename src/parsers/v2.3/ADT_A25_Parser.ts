/**
 * Parser for ADT^A25 messages (HL7 v2.3).
 *
 * @module
 */
...
/** Structured result of parsing an HL7 ADT^A25 (v2.3) message. */
export type ParsedADT_A25 = ParsedADT_A01;

/** Parser for HL7 ADT^A25 (v2.3) messages. */
...
/** Parses an HL7 ADT^A25 (v2.3) message string into a structured result. */
