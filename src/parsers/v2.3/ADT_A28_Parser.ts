/**
 * Parser for ADT^A28 messages (HL7 v2.3).
 *
 * @module
 */
...
/** Structured result of parsing an HL7 ADT^A28 (v2.3) message. */
...
/** Parser for HL7 ADT^A28 (v2.3) messages. */
...
/** Parses an HL7 ADT^A28 (v2.3) message string into a structured result. */
