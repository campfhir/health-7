/**
 * Parser for ADT^A44 messages (HL7 v2.3).
 *
 * @module
 */
...
/** Structured result of parsing an HL7 ADT^A44 (v2.3) message. */
export type ParsedADT_A44 = ParsedADT_A34;

/** Parser for HL7 ADT^A44 (v2.3) messages. */
...
/** Parses an HL7 ADT^A44 (v2.3) message string into a structured result. */
