/**
 * Builder for ADT^A28 messages (HL7 v2.5.1).
 *
 * @module
 */
...
/** ProcedureGroup — a data structure used to build an HL7 ADT^A28 (v2.5.1) message. */
...
/** InsuranceGroup — a data structure used to build an HL7 ADT^A28 (v2.5.1) message. */
...
/** Builder for HL7 ADT^A28 (v2.5.1) messages. */
...
/** Builds an HL7 ADT^A28 (v2.5.1) message. */
