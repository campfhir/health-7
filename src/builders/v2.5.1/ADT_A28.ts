...
import { ROL as ROL_base } from "../../segments/v2.3/ROL";
import { NK1 as NK1_base } from "../../segments/v2.3/NK1";
import { PV1 as PV1_base } from "../../segments/v2.3/PV1";
import { PV2 as PV2_base } from "../../segments/v2.3/PV2";
import { DB1 as DB1_base } from "../../segments/v2.3/DB1";
import { OBX as OBX_base } from "../../segments/v2.3/OBX";
import { AL1 as AL1_base } from "../../segments/v2.3/AL1";
import { DG1 as DG1_base } from "../../segments/v2.3/DG1";
import { DRG as DRG_base } from "../../segments/v2.3/DRG";
import { PR1 as PR1_base } from "../../segments/v2.3/PR1";
import { GT1 as GT1_base } from "../../segments/v2.3/GT1";
import { IN1 as IN1_base } from "../../segments/v2.3/IN1";
import { IN2 as IN2_base } from "../../segments/v2.3/IN2";
import { IN3 as IN3_base } from "../../segments/v2.3/IN3";
import { ACC as ACC_base } from "../../segments/v2.3/ACC";
import { UB1 as UB1_base } from "../../segments/v2.3/UB1";
import { UB2 as UB2_base } from "../../segments/v2.3/UB2";
...
> {
  ...
  encode(): string {
    ...
    if (!verification.valid) {
      throw new Error(
        `Cannot encode invalid ADT_A28 message:\n${verification.errors.join("\n")}`,
      );
    }
...
>(
  ...
  pid: TPID,
  pv1: TPV1,
  options: ADT_A28<TMSH, TEVN, TPID, TPD1, TROL, TNK1, TPV1, TPV2, TDB1, TOBX, TAL1, TDG1, TDRG, TPR1, TGT1, TIN1, TIN2, TIN3, TACC, TUB1, TUB2>["options"] = {},
): ADT_A28<TMSH, TEVN, TPID, TPD1, TROL, TNK1, TPV1, TPV2, TDB1, TOBX, TAL1, TDG1, TDRG, TPR1, TGT1, TIN1, TIN2, TIN3, TACC, TUB1, TUB2> {
  return new ADT_A28(msh, evn, pid, pv1, options);
}
